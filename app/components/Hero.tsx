        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div className="md:w-1/2">
            ...
            <p className="mt-3 md:mt-10 max-w-sm text-xl">
              Bestel gemakkelijk uw Windows 11 key, of Windows 11 Pro key. 
              Binnen 1 minuut na uw bestelling in uw mailbox. 
              Wij bieden naast dit ook nog Windows 10 licenties en Office licenties.
            </p>
          ...
          <div className="mt-5 md:mt-0 md:w-1/2 flex justify-center">
            <Image src={Windows11} alt="Windows 11 Pro key" height={1000} width={600} />
          </div>
        </div>
      </div>
    </div>
