			...
			{PRODUCTS.map((product, index) => (
				<div key={index}>
					<div className={`flex ${index % 2 !== 0 && "flex-row-reverse"}`}>
						<div className='w-1/2 bg-primary flex flex-col justify-center items-center gap-8 text-white py-24'>
						...
						<div className={`w-1/2 bg-[#fcfcfc] flex flex-col px-12 py-24 ${index % 2 !== 0 && "pl-32"}`}>
